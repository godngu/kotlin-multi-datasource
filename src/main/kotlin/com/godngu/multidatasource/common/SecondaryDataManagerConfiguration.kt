...
@EnableJpaRepositories(
    // Repository 패키지 위치
    basePackages = ["com.godngu.multidatasource.domain.secondary"],
    entityManagerFactoryRef = "secondaryEntityManagerFactory",
    transactionManagerRef = "secondaryTransactionManager",
)
class SecondaryDataManagerConfiguration {
    ...
    fun secondaryEntityManagerFactory(
        ...
        factory.persistenceUnitName = "secondaryEntityManager"
        // DataSource 이용하는 도메인의 Entity 가 위치한 패키지
        factory.setPackagesToScan("com.godngu.multidatasource.domain.secondary")
    ...
    fun secondaryTransactionManager(@Qualifier("secondaryEntityManagerFactory") entityManagerFactory: EntityManagerFactory): PlatformTransactionManager {
    ...
    @Bean
    fun secondaryExceptionTranslationPostProcessor(): PersistenceExceptionTranslationPostProcessor =
